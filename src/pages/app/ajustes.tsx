        ...
        <CardContent className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  CPF: {user?.email ? formatCPF(user.email) : ""}
                </p>
                <p className="text-sm text-muted-foreground">
                  Matrícula: {user?.id_grupo_permissoes}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                <RefreshCw
                  className={`mr-2 h-4 w-4 shrink-0 text-muted-foreground ${isUpdating ? "animate-spin" : ""}`}
                />
              ...
              >
                <Database
                  className={`mr-2 h-4 w-4 shrink-0 text-muted-foreground ${isClearing ? "animate-pulse" : ""}`}
                />
                <div className="text-left">
